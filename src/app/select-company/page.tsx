    ...
    <main className="flex min-h-dvh items-center justify-center bg-navy-900 px-5 py-12">
      <div className="w-full max-w-3xl space-y-8">
        <div className="space-y-2 text-center">
          <div className="mx-auto grid size-10 place-items-center rounded-lg bg-teal-500 text-sm font-bold text-navy-950">
            FID
          </div>
          <h1 className="text-xl font-semibold tracking-tight text-white">
            Welcome back, {user.name.split(' ')[0]}
          </h1>
          <p className="text-sm text-navy-300">Choose the company you want to work in.</p>
        </div>
