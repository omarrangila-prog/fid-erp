...
export function CompanyChoice({
  ...
  return (
    <button
      ...
      onClick={choose}
      disabled={pending}
      className="group flex flex-col gap-4 rounded-xl border border-forest-700 bg-forest-800 p-5 text-left transition-colors hover:border-gold-500 hover:bg-forest-800/70 disabled:opacity-60"
    >
      ...
      <dl className="grid grid-cols-1 gap-2 border-t border-forest-700 pt-3 min-[380px]:grid-cols-3">
        {[
