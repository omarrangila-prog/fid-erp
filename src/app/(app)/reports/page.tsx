...
const CATALOGUE: Catalogued[] = [
  ...
  { href: '/reports/cogs', title: 'Cost of Goods Sold', category: 'Profitability', pinned: false,
  ...
  { href: '/reports/sales', title: 'Sales Report', category: 'Sales', pinned: true,
  ...
  { href: '/reports/purchases', title: 'Purchase Report', category: 'Purchases', pinned: true,
  ...
  { href: '/reports/shipment-cost', title: 'Shipment Cost Report', category: 'Shipments', pinned: true,
  ...
  { href: '/ports', title: 'Ports', category: 'Masters', pinned: false,
  ...
  { href: '/reports/overhead-allocation', title: 'Overhead Allocation', category: 'Purchases', pinned: false,
